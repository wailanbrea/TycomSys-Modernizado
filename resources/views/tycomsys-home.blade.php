...
<style>
    ...
    /* Efectos de texto para el hero - Mejorados */
    .text-gradient {
        background: linear-gradient(135deg, #ffffff 0%, #47b2e4 100%);
    ...
    .text-glow {
        text-shadow: 
            0 0 20px rgba(71, 178, 228, 0.5),
            0 0 40px rgba(71, 178, 228, 0.3);
    }
    ...
    .text-slide-in-right {
        ...
        animation: slide-in-right 1.5s ease-out 0.3s forwards;
    }
    ...
    /* Animaciones de keyframes - Simplificadas y fluidas */
    @keyframes gradient-shift {
        ...
        50% {
            background: linear-gradient(135deg, #47b2e4 0%, #175acf 100%);
            -webkit-background-clip: text;
            -webkit-text-fill-color: transparent;
        }
        100% {
