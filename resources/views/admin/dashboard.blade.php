...
<head>
    ...
    <title>Dashboard Admin - TicomSys</title>
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="flex justify-between items-center py-6">
                    <div class="flex items-center">
                        ...
                        <h1 class="ml-3 text-2xl font-bold text-gray-900">Dashboard Admin</h1>
                    </div>
            ...
            <div class="px-4 py-6 sm:px-0">
                ...
                <div class="mt-8">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <a href="{{ route('admin.users') }}" class="bg-white p-6 rounded-lg shadow hover:shadow-md transition-shadow">
                        ...
                        <a href="{{ route('admin.roles') }}" class="bg-white p-6 rounded-lg shadow hover:shadow-md transition-shadow">
                            <h3 class="text-lg font-medium text-gray-900">Gestionar Roles</h3>
                            <p class="text-gray-600 mt-2">Configurar roles y permisos</p>
                        </a>
                    </div>
                </div>
                ...
                <!-- Users List -->
                <div class="mt-8">
                    <h2 class="text-lg font-medium text-gray-900 mb-4">Usuarios del Sistema</h2>
